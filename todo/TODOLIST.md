...
|----------|------|----------|--------|------|
| high | Depth-confounder check: re-run EBV classifier with `log(_raw_depth)`+`log(total_host_UMI)` covariates and compute per-gene E-values → quantify how much of AUC 0.866 survives depth adjustment. See [depth-confounder-check.md](depth-confounder-check.md) (idea 5a) | validation | open | 2026-07-01 |
