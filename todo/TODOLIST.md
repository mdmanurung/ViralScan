...
| medium | Cross-validate the depth-matched AUC ~0.72 with a CPM/fraction EBV label; characterize the 5 depth-robust genes (GO/pathway) — do they form a coherent EBV host-response program? | analysis | open | 2026-07-01 |
