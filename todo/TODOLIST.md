...
| high | Re-analysis with a depth-independent EBV label (CPM/fraction or depth-matched case-control), re-estimating host-response on the 5 depth-robust genes — the principled fix for the depth confound (from depth-confounder-check) | analysis | open | 2026-07-01 |
