...
_multimap_pseudocount = float(cfg_in.get("multimap_pseudocount", DEFAULTS["multimap_pseudocount"]))
if _multimap_pseudocount <= 0:
    raise ValueError(f"multimap_pseudocount must be > 0, got {_multimap_pseudocount}.")
